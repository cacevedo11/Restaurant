    ...
    <div className='md:hover:drop-shadow-[0_35px_35px_rgba(0,0,0,0.25)]'>
        ...
        <div className='flex flex-col justify-evenly items-center space-y-0 '>
          ...
          <div className='rounded-full bg-white drop-shadow-md shadow-black px-1'>
            <button className='cursor-pointer px-3 bg-white-500 hover:rounded-full active:rounded-full hover:bg-white-600 active:bg-gray-300 focus:outline-none focus:ring focus:ring-gray-300'>-</button>
            <span className='px-1 cursor-pointer'> 0 </span>
            <button className='cursor-pointer px-3 bg-white-500 hover:rounded-full active:rounded-full hover:bg-white-600 active:bg-gray-300 focus:outline-none focus:ring focus:ring-gray-300'>+</button>
          </div>
        </div>
